...
var NumbersCollection = /** @class */ (function (_super) {
    ...
    NumbersCollection.prototype.compare = function (letfIndex, rightIndex) {
        return this.data[letfIndex] > this.data[rightIndex];
    };
    NumbersCollection.prototype.swap = function (letfIndex, rightIndex) {
        var leftHand = this.data[letfIndex];
